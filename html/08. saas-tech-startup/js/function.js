(function ($) {
	...
	/* Trusted Client Logo Slider JS */
	if ($('.trusted-client-slider').length) {
		const testimonial_company_slider = new Swiper('.trusted-client-slider .swiper', {
			slidesPerView : 2,
			speed: 2000,
			spaceBetween: 30,
			loop: true,
	...
	var $what_we_do_list = $('.what-we-do-list');
